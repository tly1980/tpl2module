...
(function() {
  "use strict";
  var ArgumentParser, args, fs, mustache, outpath, parser, path, tpl2module;
  ...
  tpl2module.compile(args.src_folder, function(ret) {
    ...
    if (args.amdjs) {
      ...
      the_content += mustache.render("define({{{content}}});", {
        content: content
      });
    ...
    if (args.template) {
      the_content = '//generated by tpl2js - http://github.com/tly1980/tpl2modue\n';
      the_content += mustache.render(args.template, {
        content: content
      });
